    ...
    <div className="container">
         ...
         { namefromSessionStorage ?(
           <>
                {/* if user had already once submitted the the heading and the button will only be displayed */}
                  <hi variant="h3" style={{marginTop:'2rem',marginBottom:'2rem',width:'100%', fontSize:'2rem'}}>
      ...
      {/* input field for username */}
          ...
          {Object.keys(formErrors).length === 0 && isSubmit  ?(
             ...
             <Link to="/" className="button">
                 <Button variant="contained" size="large" color="success" onClick={()=>save()} style={{position:'unset'}} >
            Back To Home!
           </Button>
           </Link>
          ):
